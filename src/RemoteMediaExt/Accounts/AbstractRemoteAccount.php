...
abstract class AbstractRemoteAccount
{
  ...
  public function fetch()
  {
    if (!is_null($this->localID)) {
      ...
      if (!empty($serviceClass)) {
        $serviceClass = $this->retrieveClassName($serviceClass);
  ...
  public function getDbClassName($classname)
  {
      return str_replace('\\','_',$classname);
  }

  public function retrieveClassName($dbclassname)
  {
      return str_replace('_','\\',$dbclassname);
  }
  ...
  public function set($name, $value)
  {
      if ($name == 'remote_account_type') {
          $this->type = $value;
          $this->set('service_class',$this->getDbClassName(RemoteServiceFactory::getClass($this->type)));
          return $this;
      }
