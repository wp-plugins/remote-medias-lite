...
use WPRemoteMediaExt\Guzzle\Batch\BatchTransferInterface;
use WPRemoteMediaExt\Guzzle\Batch\BatchDivisorInterface;
 ...
 * This class is to be used with {@see WPRemoteMediaExt\Guzzle\Batch\BatchInterface}
 */
    ...
    public function createBatches(\SplQueue $queue)
    {
        ...
        foreach ($queue as $item) {
            if (!$item instanceof CommandInterface) {
                throw new InvalidArgumentException('All items must implement WPRemoteMediaExt\Guzzle\Service\Command\CommandInterface');
            }
