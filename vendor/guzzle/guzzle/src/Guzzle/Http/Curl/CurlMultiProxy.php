...
namespace WPRemoteMediaExt\Guzzle\Http\Curl;
...
class CurlMultiProxy extends AbstractHasDispatcher implements CurlMultiInterface
{
    ...
    public function __construct($maxHandles = 3)
    {
        ...
        class_exists('WPRemoteMediaExt\Guzzle\Http\Message\Response');
        class_exists('WPRemoteMediaExt\Guzzle\Http\Exception\CurlException');
    }
