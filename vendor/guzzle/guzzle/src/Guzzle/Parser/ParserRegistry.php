...
namespace WPRemoteMediaExt\Guzzle\Parser;
...
class ParserRegistry
{
    ...
    protected $mapping = array(
        'message'      => 'WPRemoteMediaExt\Guzzle\\Parser\\Message\\MessageParser',
        'cookie'       => 'WPRemoteMediaExt\Guzzle\\Parser\\Cookie\\CookieParser',
        'url'          => 'WPRemoteMediaExt\Guzzle\\Parser\\Url\\UrlParser',
        'uri_template' => 'WPRemoteMediaExt\Guzzle\\Parser\\UriTemplate\\UriTemplate',
    );
    ...
    public function __construct()
    {
        ...
        if (extension_loaded('uri_template')) {
            $this->mapping['uri_template'] = 'WPRemoteMediaExt\Guzzle\\Parser\\UriTemplate\\PeclUriTemplate';
        }
    }
