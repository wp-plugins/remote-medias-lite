...
namespace WPRemoteMediaExt\Guzzle\Service\Description;
...
class Operation implements OperationInterface
{
    ...
    const DEFAULT_COMMAND_CLASS = 'WPRemoteMediaExt\Guzzle\\Service\\Command\\OperationCommand';
     ...
     * 'WPRemoteMediaExt\Guzzle\\Foo\\Baz', or 'MyModelName' (to reference a model by ID).
     *
