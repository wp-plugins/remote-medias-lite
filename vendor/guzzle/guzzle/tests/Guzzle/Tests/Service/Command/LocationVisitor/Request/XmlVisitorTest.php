...
use WPRemoteMediaExt\Guzzle\Service\Command\LocationVisitor\Request\XmlVisitor;
...
/**
 * @covers WPRemoteMediaExt\Guzzle\Service\Command\LocationVisitor\Request\XmlVisitor
 */
class XmlVisitorTest extends AbstractVisitorTestCase
{
    ...
    public function testSerializesXml(array $operation, array $input, $xml)
    {
        ...
        $command = $this->getMockBuilder('WPRemoteMediaExt\Guzzle\Service\Command\OperationCommand')
