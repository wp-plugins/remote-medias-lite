...
class RegisterListenersPassTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testEventSubscriberWithoutInterface()
    {
        ...
        $definition = $this->getMock('WPRemoteMediaExt\Symfony\Component\DependencyInjection\Definition');
        ...
        $builder = $this->getMock('WPRemoteMediaExt\Symfony\Component\DependencyInjection\ContainerBuilder');
