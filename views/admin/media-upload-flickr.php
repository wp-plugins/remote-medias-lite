...
<script type="text/html" id="tmpl-media-upload-flickr-upgrade">
  <div class="uploader-inline rm-upload-wrap">
        ...
        <br>
				<a href="http://www.onecodeshop.com/remote-media-pro-flickr" target="_blank" class="browser button button-hero" id="flickr-pro-link" style="position: relative; z-index: 0; display: inline;"><?php _e('Get the extension and start uploading &raquo;');?></a>
			</div>
