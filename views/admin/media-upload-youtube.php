...
<script type="text/html" id="tmpl-media-upload-youtube-upgrade">
	<div class="uploader-inline rm-upload-wrap">
        ...
        <br>
				<a href="http://www.onecodeshop.com/remote-media-pro-youtube" target="_blank" class="browser button button-hero" id="vimeo-pro-link" style="position: relative; z-index: 0; display: inline;"><?php _e('Get the extension and start uploading &raquo;');?></a>
			</div>
