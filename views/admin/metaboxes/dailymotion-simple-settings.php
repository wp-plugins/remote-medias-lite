...
//$metabox
//account
$accountTypeSlug = 'dailymotion';
?>
<div class="rmlfields rmlfields-<?php echo $accountTypeSlug;?>">
<?php
echo $hidden_nonce;
?>
<input type="hidden" id="service_class" name="account_meta[<?php echo $accountTypeSlug;?>][service_class]" value="\WPRemoteMediaExt\RemoteMediaExt\Accounts\Dailymotion\ServiceDailymotionSimple" >

<label for="remote_user_id"><?php _e("Dailymotion User ID", 'remote-medias-lite' );?></label>
